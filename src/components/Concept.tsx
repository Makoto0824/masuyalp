          ...
          <div className="text-center">
            <div className="marugame-card p-10 relative">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                2008年、関西出身のご夫婦がここ湘南台で始めた「串かつ 枡や」。関東ではあまり馴染みのなかった「串かつ」に、開店当初は食べ方に戸惑うお客様も多かったとか。本場大阪の味を伝え守り続け、地元の方々に愛されてきたお店です。これからも変わらぬ大阪の串カツを、湘南台の皆さまと共に楽しみ、家族や仲間と笑顔で過ごせる場所であり続けたい。「枡や」は、これまでも、これからも。湘南台の街に寄り添い、皆さまに愛されるお店を目指して精進してまいります。
              </p>
              {/* 赤色の装飾要素 */}
