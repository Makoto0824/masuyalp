          ...
          <div className="space-y-8">
            <div className="marugame-card p-8 marugame-red-card shadow-lg border border-red-100">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">営業時間内にお気軽にお電話ください</p>
                <a
                  href="tel:0466-44-2909"
                  className="marugame-button text-lg px-8 py-4 inline-block shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                >
                  今すぐ電話する
                </a>
              </div>
